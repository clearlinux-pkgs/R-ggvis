...
Version  : 0.4.9
Release  : 54
URL      : https://cran.r-project.org/src/contrib/ggvis_0.4.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ggvis_0.4.9.tar.gz
Summary  : Interactive Grammar of Graphics
Group    : Development/Tools
License  : GPL-2.0 MIT
Requires: R-ggvis-license = %{version}-%{release}
...
%package license
Summary: license components for the R-ggvis package.
Group: Default

%description license
license components for the R-ggvis package.


%prep
%setup -q -n ggvis
pushd ..
cp -a ggvis buildavx2
popd
pushd ..
cp -a ggvis buildavx512
popd
pushd ..
cp -a ggvis buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740093715
...
/usr/share/package-licenses/R-ggvis/8b66ce7ad21c704ba8f23eb765d9f91aa5218078
